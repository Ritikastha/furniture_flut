...
class NotificationService{
  ...
  static Future<void> display(String title,String body,String payload,BuildContext _context) async {
    context=_context;
    // if image from asset
    final bigpicture = await getImageFilePathFromAssets(
        'assets/images/a.png', 'bigpicture');
    final smallpicture = await getImageFilePathFromAssets(
        'assets/images/a.png', 'smallpicture');
